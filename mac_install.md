...
* To make submission easier, you should **"create an ssh key" key** for your GitHub account.
  ...
  In these instructions, you'll see lines that bein with a $ or #.  Typically in coding instructions, $ is understood to be your prompt, and anything following a # is a comment.
